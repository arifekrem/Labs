...
def task2():    #Works
    ...
    '''
    p2file1 =  open('QA_Pairs.txt', 'r') 
    p2file2 = open('unique_QA_Pairs.txt', 'w')
    p2file3 = open('Overlapping.txt', 'w')
...
def task3():    # Works
    ...
    p3.close()
    return p3dict["question How does Arya annoy Bran?\n"]
...
def task4():    # Works, I am not sure if I am supposed to remove line from the original file :/
    ...
    with open('Questions.txt', 'r') as p4:
        for line in p4:
            return line
            break
...
def task6():    # Works
    ...
    with open('Frequency.txt', 'r') as p6file2:
        for line in p6file2:
            return line
            break
...
def task7():    # Works
    ...
    with open('Decreasing_Frequency.txt', 'r') as p7file2:
        for line in p7file2:
            return line
            break
...
class MyTests(unittest.TestCase):
    def test1(self):
        tsk1 = a2.task1()
        self.assertEqual(a2.task1(), 10)
    
    def test2(self):
        tsk2 = a2.task2()
        self.assertEqual(a2.task2(), 'answer out-shooting him\n')
    
    def test3(self):
        tsk3 = a2.task3()
        self.assertEqual(a2.task3(), 'answer laughs at their antics\n')

    def test4(self):
        tsk4 = a2.task4()
        self.assertEqual(a2.task4(), 'question How does Arya annoy Bran?\n')

    def test5(self):
        tsk5 = a2.task5()
        self.assertEqual(a2.task5(), 'answer out-shooting him\n')
    
    def test6(self):
        tsk6 = a2.task6()
        self.assertEqual(a2.task6(), 'answer , 0.07692307692307693 \n')
      
    def test7(self):
        tsk7 = a2.task7()
        self.assertEqual(a2.task7(), 'answer , 0.07692307692307693 \n')
